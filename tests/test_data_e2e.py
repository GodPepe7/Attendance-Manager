...
users = [
    ...
    User("isagi", "student4@htw.de", _user_password_hash, Role.STUDENT, 5),
...
lectures = [
    ...
    Lecture(1, datetime(2025, 1, 6), 4),
    Lecture(2, datetime(2025, 1, 23), 5),
]

course_students = [
    CourseStudent(users[1], 1, {lectures[3]}, 1),
...
courses = [
    ...
    Course("Projektmanagement", users[0], 2, "", None, {lectures[4]}, {course_students[4]}),
